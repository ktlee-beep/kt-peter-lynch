...
INSERT INTO kt_stocks (code, name, market, sector, yahoo_suffix) VALUES
  ...
  ('247540','에코프로비엠','KOSPI','이차전지','KS'),
  ('086520','에코프로','KOSPI','이차전지','KS'),
  ...
  ('041510','에스엠','KOSPI','엔터','KS'),
  ('035900','JYP엔터테인먼트','KOSPI','엔터','KS'),
  ('122870','와이지엔터테인먼트','KOSPI','엔터','KS'),
